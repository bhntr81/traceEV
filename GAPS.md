...
`--game plo`, and Omaha 2-of-4 strength shipped. What stays out
of this track is still out: no HUD, no solver, no invented equity,
no 13×13 of four-card hands, no PokerStars Omaha import.
...
| **Omaha equity / 13×13** | Four hole cards have no two-card combo and no Hold'em all-in EV. `--game plo --chart` is empty. Inventing a 169-square of PLO hands, or scoring 2+3 as seven-card Hold'em, is a lie. |
