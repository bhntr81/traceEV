...
a second time.
    ...
    HOLDEM    two hole cards. Strength, the 13x13 and all-in equity
              are built for this and only this.
    OMAHA     four hole cards, pot-limit Omaha. Imported, tagged,
              filterable. Not classified as a Hold'em hand.
    OMAHA5    five hole cards. Same: stored and tagged, no fake equity.
